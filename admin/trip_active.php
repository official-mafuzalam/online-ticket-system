...
if (isset($_POST['submit_active'])) {
    ...
    $sql = "UPDATE trip_status SET status = 1 WHERE id = $coach_id";

    $result = mysqli_query($con, $sql);

    if ($result) {
        echo "<script>alert('Trip Active Successfully');
...
if (mysqli_num_rows( $result ) > 0) {
    ...
    <div class="modal-body">
        <form class="container text-center" action="trip_active.php" method="POST"">
            ...
            <input type="submit" name="submit_active" class="btn btn-success" value="Active">
